          ...
          <ScrollReveal delay={0.2}>
            <div className="bg-white/10 border border-white/20 p-8 backdrop-blur">
              ...
              <div className="space-y-4">
                ...
                <button className="w-full font-medium bg-white text-primary py-3.5 text-base flex items-center justify-center gap-2 hover:bg-white/90 transition-colors mt-2 group">
                  Submit Application
                  <ArrowRight size={15} className="transition-transform group-hover:translate-x-1" />
                </button>
